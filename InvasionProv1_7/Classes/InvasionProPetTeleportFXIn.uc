class InvasionProPetTeleportFXIn extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(1)=(RelativeTime=0.200000,Color=(B=192,G=128))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=255,R=70))
     ...
     End Object
     Emitters(0)=SpriteEmitter'InvasionProv1_7.InvasionProPetTeleportFXIn.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         UniformSize=True
         ColorScale(1)=(RelativeTime=0.200000,Color=(B=192,G=128))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=255,R=83))
         ColorScale(3)=(RelativeTime=1.000000)
     ...
     End Object
     Emitters(1)=SpriteEmitter'InvasionProv1_7.InvasionProPetTeleportFXIn.SpriteEmitter1'
