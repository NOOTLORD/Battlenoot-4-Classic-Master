class InvasionProPetSelectionMenu extends GUICustomPropertyPage;
...
function Initialize()
{
	...
	{
		currentSelectInfo.Caption = "The server is running in pet tier mode. In tier mode you can select a new, stronger pet each time your pet reaches the max level for its tier. Please select a pet from the list.";
	...
	for(i=0;i<250;i++)
	{
		PetName = MyPetStats.GetServerPet(i);
		if(PetName != "None")
		{
...
function bool InternalOnClick(GUIComponent Sender)
{
	...
	if(Sender == b_OK)
	{
		...
		if(PetClass != None)
		{
			if(!InvasionProPetMenuConfig(ParentPage).PlayerHasPet())
			{
				InvasionProPetMenuConfig(ParentPage).DiscardPet(false);
			}
			else
			{
				InvasionProPetMenuConfig(ParentPage).DiscardPet(true);
			}

			MyPetStats.ServerSetPetClass(PetClassName);
			b_OK.DisableMe();
...
defaultproperties
{
     Begin Object Class=GUILabel Name=SelectInfo
         Caption="Please select a pet from the list of server pets."
         bMultiLine=True
         FontScale=FNS_Small
         StyleName="TextLabel"
         WinTop=0.221338
         ...
         bScaleToParent=True
     End Object
     currentSelectInfo=GUILabel'InvasionProv1_7.InvasionProPetSelectionMenu.SelectInfo'
     ...
     Begin Object Class=moComboBox Name=PetClass
         ...
         OnChange=InvasionProPetSelectionMenu.InternalOnChange
     End Object
     currentPetClass=moComboBox'InvasionProv1_7.InvasionProPetSelectionMenu.PetClass'
     ...
     Begin Object Class=moComboBox Name=c_animlist
         ...
         OnChange=InvasionProPetSelectionMenu.InternalOnChange
     End Object
     currentAnimList=moComboBox'InvasionProv1_7.InvasionProPetSelectionMenu.c_animlist'
     ...
     Begin Object Class=GUIGFXButton Name=PanUp
         ...
         OnClick=InvasionProPetSelectionMenu.PanView
         OnKeyEvent=PanUp.InternalOnKeyEvent
     End Object
     b_UArrow=GUIGFXButton'InvasionProv1_7.InvasionProPetSelectionMenu.PanUp'
     ...
     End Object
     b_DArrow=GUIGFXButton'InvasionProv1_7.InvasionProPetSelectionMenu.PanDown'
     ...
     End Object
     b_LArrow=GUIGFXButton'InvasionProv1_7.InvasionProPetSelectionMenu.PanLeft'
     ...
     End Object
     b_RArrow=GUIGFXButton'InvasionProv1_7.InvasionProPetSelectionMenu.PanRight'
     ...
     End Object
     b_CArrow=GUIGFXButton'InvasionProv1_7.InvasionProPetSelectionMenu.PanReset'
     ...
     Begin Object Class=GUIGFXButton Name=Play
         ...
         bRepeatClick=True
         OnClickSound=CS_Down
         OnClick=InvasionProPetSelectionMenu.AnimControls
         OnKeyEvent=Play.InternalOnKeyEvent
     End Object
     b_Play=GUIGFXButton'InvasionProv1_7.InvasionProPetSelectionMenu.Play'
     ...
     End Object
     b_Pause=GUIGFXButton'InvasionProv1_7.InvasionProPetSelectionMenu.Pause'
     ...
     Begin Object Class=GUIButton Name=DropTarget
         ...
         OnCapturedMouseMove=InvasionProPetSelectionMenu.RaceCapturedMouseMove
     End Object
     b_DropTarget=GUIButton'InvasionProv1_7.InvasionProPetSelectionMenu.DropTarget'
     ...
     Begin Object Class=moSlider Name=ModelFOV
         ...
         OnChange=InvasionProPetSelectionMenu.InternalOnChange
     End Object
     currentModelFOV=moSlider'InvasionProv1_7.InvasionProPetSelectionMenu.ModelFOV'
     ...
     Begin Object Class=GUILabel Name=ModelDrawer
         ...
         WinHeight=0.557467
         RenderWeight=0.200000
         OnDraw=InvasionProPetSelectionMenu.InternalDraw
     End Object
     currentModelViewer=GUILabel'InvasionProv1_7.InvasionProPetSelectionMenu.ModelDrawer'
     ...
     Begin Object Class=moSlider Name=ModelRot
         ...
         OnChange=InvasionProPetSelectionMenu.InternalOnChange
     End Object
     currentModelRotation=moSlider'InvasionProv1_7.InvasionProPetSelectionMenu.ModelRot'
     ...
     Begin Object Class=GUIButton Name=CancelButton
         ...
         bBoundToParent=True
         bScaleToParent=True
         OnClick=InvasionProPetSelectionMenu.InternalOnClick
         OnKeyEvent=CancelButton.InternalOnKeyEvent
     End Object
     b_Cancel=GUIButton'InvasionProv1_7.InvasionProPetSelectionMenu.CancelButton'
     ...
     End Object
     b_OK=GUIButton'InvasionProv1_7.InvasionProPetSelectionMenu.OkButton'
