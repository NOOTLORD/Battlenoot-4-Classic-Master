...
#exec TEXTURE IMPORT NAME=xCausticRing2 FILE=TEXTURES\CausticRing2.dds GROUP=Water Alpha=1 DXT=5
#exec TEXTURE IMPORT NAME=xSplashBase FILE=TEXTURES\SplashBase.dds GROUP=Water Alpha=1 DXT=5
#exec TEXTURE IMPORT NAME=xWaterDrops2 FILE=TEXTURES\WaterDrops2.dds GROUP=Water Alpha=1 DXT=5
