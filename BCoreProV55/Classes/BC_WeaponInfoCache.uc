...
defaultproperties
{
     ...
     Weapons(6)=(ClassName="BallisticProV55.Fifty9MachinePistol",ItemName="Fifty-9 Submachine gun",SmallIconMaterial=Texture'BallisticUI.Icons.SmallIcon_Fifty9',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=2,BigIconMaterial=Texture'BallisticUI.Icons.BigIcon_Fifty9',bIsBW=True) 
     Weapons(7)=(ClassName="BallisticProV55.XRS10SubMachinegun",ItemName="XRS-10 Submachine gun",SmallIconMaterial=Texture'BallisticUI.Icons.SmallIcon_XRS10',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=2,BigIconMaterial=Texture'BallisticUI.Icons.BigIcon_XRS10',bIsBW=True)
