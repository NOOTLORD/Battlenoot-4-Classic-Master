...
defaultproperties
{
     ...
     Weapons(23)=(ClassName="BWBPRecolorsPro.G28Grenade",ItemName="FMD G28 Medicinal Aerosol",SmallIconMaterial=Texture'BallisticRecolors3TexPro.G28.SmallIcon_G28',SmallIconCoords=(X2=127,Y2=31),BigIconMaterial=Texture'BallisticRecolors3TexPro.G28.BigIcon_G28',InventorySize=4,bIsBW=True)
     Weapons(24)=(ClassName="BWBPRecolorsPro.LK05Carbine",ItemName="LK-05 Advanced Carbine",SmallIconMaterial=Texture'BallisticRecolors4TexPro.LK05.SmallIcon_LK05',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=4,BigIconMaterial=Texture'BallisticRecolors4TexPro.LK05.BigIcon_LK05',InventorySize=7,bIsBW=True)
     Weapons(25)=(ClassName="BWBPRecolorsPro.MGLauncher",ItemName="Conqueror MGL",SmallIconMaterial=Texture'BallisticRecolors4TexPro.MGL.SmallIcon_MGL',SmallIconCoords=(X2=127,Y2=35),InventoryGroup=8,BigIconMaterial=Texture'BallisticRecolors4TexPro.MGL.BigIcon_MGL',InventorySize=7,bIsBW=True)
     Weapons(26)=(ClassName="BWBPRecolorsPro.SKASShotgun",ItemName="SKAS-21 Automatic Shotgun",SmallIconMaterial=Texture'BallisticRecolors3TexPro.SKAS.SmallIcon_SKAS',SmallIconCoords=(X2=127,Y2=30),InventoryGroup=7,BigIconMaterial=Texture'BallisticRecolors3TexPro.SKAS.BigIcon_SKAS',InventorySize=7,bIsBW=True)
     Weapons(27)=(ClassName="BWBPRecolorsPro.X82Rifle",ItemName="X83 Sniper Rifle",SmallIconMaterial=Texture'BallisticRecolors3TexPro.X82.SmallIcon_X82',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=9,BigIconMaterial=Texture'BallisticRecolors3TexPro.X82.BigIcon_X82',InventorySize=7,bIsBW=True)
     Weapons(28)=(ClassName="BallisticProV55.M46AssaultRifleQS",ItemName="M46 Red Dot Sight",SmallIconMaterial=Texture'BallisticTextures_25.OA-AR.SmallIcon_OAAR',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=4,BigIconMaterial=Texture'BallisticTextures_25.OA-AR.BigIcon_OAAR',InventorySize=7,bIsBW=True)
     Weapons(29)=(ClassName="BWBPOtherPackPro.Z250Minigun",ItemName="Z-250 Minigun",SmallIconMaterial=Texture'BWBPOtherPackTex2.Z250.Icon_Z250',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=6,BigIconMaterial=Texture'BWBPOtherPackTex2.Z250.BigIcon_Z250',InventorySize=8,bIsBW=True)
     Weapons(30)=(ClassName="BWBPRecolorsPro.SK410Shotgun",ItemName="SK-410 Assault Shotgun",SmallIconMaterial=Texture'BallisticRecolors3TexPro.SK410.SmallIcon_SK410',SmallIconCoords=(X2=127,Y2=35),InventoryGroup=7,BigIconMaterial=Texture'BallisticRecolors3TexPro.SK410.BigIcon_SK410',InventorySize=7,bIsBW=True)
     Weapons(31)=(ClassName="BallisticProV55.R9RangerRifle",ItemName="R9 Ranger Rifle",SmallIconMaterial=Texture'BallisticTextures3.ui.SmallIcon_R9',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=9,BigIconMaterial=Texture'BallisticTextures3.ui.BigIcon_R9',InventorySize=7,bIsBW=True)
}
