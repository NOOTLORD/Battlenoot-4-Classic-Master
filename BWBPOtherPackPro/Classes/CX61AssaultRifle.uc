...
defaultproperties
{
     ...
     CockSound=(Sound=Sound'BallisticSounds3.SAR.SAR-Cock',Volume=0.600000)
     ReloadAnimRate=1.100000
     ClipOutSound=(Sound=Sound'BallisticSounds3.SAR.SAR-ClipOut',Volume=0.600000)
     ClipInSound=(Sound=Sound'BallisticSounds3.SAR.SAR-ClipIn',Volume=0.600000)
     ClipInFrame=0.650000
     bCockOnEmpty=True
     WeaponModes(0)=(ModeName="Healing Gas",ModeID="WM_FullAuto")
     WeaponModes(1)=(ModeName="Full Auto",bUnavailable=True,ModeID="WM_FullAuto")
