//=============================================================================
// Primaryfire class for the AK-470 Assault Rifle
//
...
defaultproperties
{
     ...
     DamageType=Class'BWBPRecolorsPro.DT_AK470Assault'
     DamageTypeHead=Class'BWBPRecolorsPro.DT_AK470AssaultHead'
     DamageTypeArm=Class'BWBPRecolorsPro.DT_AK470Assault'
     ...
     BallisticFireSound=(Sound=SoundGroup'BallisticRecolorsSounds.AK470.AK470-Fire',Volume=1.150000,Slot=SLOT_Interact,bNoOverride=False)
     FireRate=0.115000
