...
defaultproperties
{
     ...
     MagAmmo=24
     CockSound=(Sound=Sound'PackageSounds4Pro.MRDR.MRDR-Cock',Volume=1.250000)
     ClipHitSound=(Volume=0.200000)
     ClipOutSound=(Sound=Sound'PackageSounds4Pro.MRDR.MRDR-ClipOut',Volume=0.120000)
     ClipInSound=(Sound=Sound'PackageSounds4Pro.MRDR.MRDR-ClipIn',Volume=1.000000)
     ClipInFrame=0.650000
     bCockOnEmpty=True
     WeaponModes(0)=(bUnavailable=True)
     WeaponModes(1)=(ModeName="Small Burst",bUnavailable=True,Value=5.000000)
     bUseSights=False
     ...
     FireModeClass(1)=Class'BWBPRecolorsPro.MRDRPrimaryFire'
