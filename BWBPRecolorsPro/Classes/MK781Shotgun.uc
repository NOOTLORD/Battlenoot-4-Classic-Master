...
defaultproperties
{
     ...
     MagAmmo=8
     CockSound=(Sound=Sound'PackageSounds4ProExp.M781.M781-Pump',Volume=0.750000,Radius=32.000000)
     ReloadAnim="ReloadLoop"
     ReloadAnimRate=1.300000
     ClipInSound=(Sound=Sound'PackageSounds4ProExp.Mk781.Mk781-ShellPlus',Volume=0.750000,Radius=32.000000)
     ...
     FireModeClass(1)=Class'BWBPRecolorsPro.MK781PrimaryFire'
