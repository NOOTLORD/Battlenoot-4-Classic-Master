...
simulated function AddHeat(float Amount)
{
	...
	if (HeatLevel >= 10)
	{
		...
		class'BallisticDamageType'.static.GenericHurt (Instigator, 25, None, Instigator.Location, -vector(Instigator.GetViewRotation()) * 30000 + vect(0,0,10000), class'DTCYLOMk2Overheat');
		return;
	}
}
