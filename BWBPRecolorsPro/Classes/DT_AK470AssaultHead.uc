...
//=============================================================================
class DT_AK470AssaultHead extends DT_BWBullet;
...
defaultproperties
{
     DeathStrings(0)="%o's face was rearranged by Comrade %k's AK470."
     DeathStrings(1)="%k executed a rebellious %o with an AK headshot."
     DeathStrings(2)="%k blew the Borscht out of %o's head with an AK470."
     bHeaddie=True
     DamageIdent="Assault"
     bDisplaceAim=False
     bUseMotionBlur=False
     WeaponClass=Class'BWBPRecolorsPro.AK470AssaultRifle'
     DeathString="%o's face was rearranged by Comrade %k's AK470."
