//=============================================================================
// Weapon class for the SK410 Shotgun
//
...
defaultproperties
{
     ...
     BigIconMaterial=Texture'BallisticProUITex.Icons.SmallIcon_SK410'
     BigIconCoords=(Y1=40)
     ...
     Priority=40	 
     FireModeClass(0)=Class'BallisticProV55Recolors.SK410PrimaryFire'
     FireModeClass(1)=Class'BCoreProV55.BallisticScopeFire'
     AIRating=0.850000
     CurrentRating=0.850000
     AmmoClass(0)=Class'BallisticProV55Recolors.Ammo_SK410Shotgun'
     AmmoClass(1)=Class'BallisticProV55Recolors.Ammo_SK410Shotgun'	 
     Description="SK410"
     ...
     AttachmentClass=Class'BallisticProV55Recolors.SK410Attachment'
     IconMaterial=Texture'BallisticProUITex.Icons.BigIcon_SK410'
     ...
     Mesh=SkeletalMesh'BallisticProRecolorsAnims.SK410_FP'
     DrawScale=0.350000
	 Skins(0)=Shader'BallisticProTex.Hands.Hands-Shiny'
	 Skins(1)=Texture'BallisticProRecolorsTex.SK410.SK410-Main'
	 Skins(2)=Texture'BallisticProRecolorsTex.SK410.SK410-Misc'
	 Skins(3)=Texture'BallisticProRecolorsTex.SK410.SK410-Lights'
	 Skins(4)=Texture'BallisticProRecolorsTex.CYLO.Reflex'
	 Skins(5)=Shader'BallisticProTex.General.RedDotSightShader'
}
