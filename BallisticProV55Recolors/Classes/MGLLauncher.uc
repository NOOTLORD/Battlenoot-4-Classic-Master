//=============================================================================
// Weapon class for the MGL Launcher
//
...
defaultproperties
{
     ...
     BigIconMaterial=Texture'BallisticProUITex.Icons.BigIcon_MGL'
     ...
     BringUpSound=(Sound=Sound'BallisticProSounds.M763.M763-Pullout',Volume=0.475000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     PutDownSound=(Sound=Sound'BallisticProSounds.M763.M763-Putaway',Volume=0.475000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     MagAmmo=6
     bCockOnEmpty=False	 
     ReloadAnim="ReloadLoop"
     ReloadAnimRate=1.250000	 
     ClipOutSound=(Sound=Sound'BallisticProSounds.BX5.BX5-SecOff',Volume=0.650000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ClipInSound=(Sound=Sound'BallisticProSounds.BX5.BX5-SecOn',Volume=0.650000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ...
     Priority=245	 
     FireModeClass(0)=Class'BallisticProV55Recolors.MGLPrimaryFire'
     FireModeClass(1)=Class'BCoreProV55.BallisticScopeFire'
     AIRating=0.900000
     CurrentRating=0.900000
     AmmoClass(0)=Class'BallisticProV55Recolors.Ammo_MGLLauncher'
     AmmoClass(1)=Class'BallisticProV55Recolors.Ammo_MGLLauncher'
     Description="MGL" 
     CustomCrossHairScale=0.000000
     CustomCrossHairTextureName="Crosshairs.HUD.Crosshair_Cross1"
     InventoryGroup=4
     PlayerViewOffset=(X=9.000000,Y=-1.000000,Z=-7.000000)
     AttachmentClass=Class'BallisticProV55Recolors.MGLAttachment'
     IconMaterial=Texture'BallisticProUITex.Icons.SmallIcon_MGL'
     ...
     Mesh=SkeletalMesh'BallisticProRecolorsAnims.MGL_FP'
     DrawScale=0.130000
	 Skins(0)=Shader'BallisticProTex.Hands.Hands-Shiny'
	 Skins(1)=Texture'BallisticProRecolorsTex.MGL.MGL-Main'
	 Skins(2)=Texture'BallisticProRecolorsTex.MGL.MGL-ScreenBase'
}