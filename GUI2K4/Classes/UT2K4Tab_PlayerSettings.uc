...
var automated GUIButton	b_Left, b_Right, b_Pick, b_DropTarget;
var automated moEditBox		ed_Name;
var automated moComboBox	co_Hand, co_Voice;
...
defaultproperties
{
     ...
     All="All"
     SpinnyDudeOffset=(X=70.000000,Z=2.500000)
     DefaultText="Default"
     ...
     Begin Object Class=moComboBox Name=PlayerHand
         ...
         IniOption="@INTERNAL"
         IniDefault="Right"
         Hint="Changes in what hand your weapon is visible."
         WinTop=0.212761
         WinLeft=0.705430
         WinWidth=0.264766
         TabOrder=6
     ...
     Begin Object Class=moNumericEdit Name=PlayerFOV
         ...
         IniOption="@INTERNAL"
         IniDefault="110"
         Hint="This value will change your FOV"
         WinTop=0.076042
         WinLeft=0.705430
         WinWidth=0.266797
         TabOrder=5
