...
defaultproperties
{
     BurnClassTwo=Class'DoomMonsterPackv3.Tick_FinalBlend'
     ...
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Tick.Tick_chirp1'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Tick.Tick_chirp2'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Tick.Tick_chirp3'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Tick.Tick_chirp4'
     Footstep(0)=Sound'DoomMonsterPackv3.Tick.tick_walk1'
     Footstep(1)=Sound'DoomMonsterPackv3.Tick.tick_walk2'
     Footstep(2)=Sound'DoomMonsterPackv3.Tick.tick_walk3'
     Footstep(3)=Sound'DoomMonsterPackv3.Tick.tick_walk4'
     DodgeSkillAdjust=4.000000
     HitSound(0)=Sound'DoomMonsterPackv3.Tick.tick_pain1'
     HitSound(1)=Sound'DoomMonsterPackv3.Tick.tick_pain2'
     HitSound(2)=Sound'DoomMonsterPackv3.Tick.tick_pain3'
     HitSound(3)=Sound'DoomMonsterPackv3.Tick.tick_pain4'
     DeathSound(0)=Sound'DoomMonsterPackv3.Tick.tick_death1'
     DeathSound(1)=Sound'DoomMonsterPackv3.Tick.tick_death2'
     DeathSound(2)=Sound'DoomMonsterPackv3.Tick.tick_death3'
     DeathSound(3)=Sound'DoomMonsterPackv3.Tick.tick_death3'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Tick.tick_sight2'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Tick.tick_sight3'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Tick.Tick_chirp5'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Tick.Tick_chirp6'
     ScoringValue=5
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.TickMesh'
     DrawScale=1.800000
     PrePivot=(Z=-35.000000)
     Skins(0)=Texture'DoomMonsterPackv3.Effects.Invis_Mat'
     Skins(1)=Shader'DoomMonsterPackv3.Tick.Tick_Leg_Shader'
     Skins(2)=Texture'DoomMonsterPackv3.Tick.Tick_Skin'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Tick.PawnKParams'
