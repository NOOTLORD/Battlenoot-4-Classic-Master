...
defaultproperties
{
     FireBallCreate=Sound'DoomMonsterPackv3.Vulgar.Vulgar_fireball_create_01'
     FadeTailClass=Class'DoomMonsterPackv3.Vulgar_Tail_MaterialSequence'
     ...
     ProjectileClass(0)=Class'DoomMonsterPackv3.Vulgar_Projectile'
     ProjectileClass(1)=Class'DoomMonsterPackv3.Vulgar_Projectile'
     FadeClass=Class'DoomMonsterPackv3.Vulgar_MaterialSequence'
     SpawnFXClass=Class'DoomMonsterPackv3.Vulgar_SpawnEffect'
     BurnAnimTime=0.250000
     aimerror=5
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_melee_01'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_melee_02'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_melee_04'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_melee_05'
     Footstep(0)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_step_01a'
     Footstep(1)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_step_02a'
     Footstep(2)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_step_03a'
     Footstep(3)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_step_02a'
     DodgeSkillAdjust=4.000000
     HitSound(0)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_pain_03a'
     HitSound(1)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_pain_05'
     HitSound(2)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_pain_08'
     HitSound(3)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_pain_09'
     DeathSound(0)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_death_01'
     DeathSound(1)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_death_02'
     DeathSound(2)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_death_03'
     DeathSound(3)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_death_04'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_cc_03'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_sight_03'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_sight_04'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Vulgar.Vulgar_sight_05'
     FireSound=Sound'DoomMonsterPackv3.Vulgar.Vulgar_fireball_create_02'
     ScoringValue=5
     ...
     IdleRestAnim="Idle2"
     IdleChatAnim="Idle2"
     Mesh=SkeletalMesh'DoomMonsterPackv3.VulgarMesh'
     DrawScale=1.250000
     PrePivot=(Z=-40.000000)
     Skins(0)=Shader'DoomMonsterPackv3.Vulgar.Vulgar_Eye_Shader'
     Skins(1)=Texture'DoomMonsterPackv3.Vulgar.Vulgar_Tail_Skin'
     Skins(2)=Texture'DoomMonsterPackv3.Vulgar.Vulgar_Skin'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Vulgar.PawnKParams'
