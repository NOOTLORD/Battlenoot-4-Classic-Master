...
function Timer()
{
	...
	foreach VisibleCollidingActors(class'Monster', M, SeekerLinkRange, Location)
	{
		...
		{
			SeekerInv = class<Inventory>(DynamicLoadObject("DoomMonsterPackv3.Seeker_Inventory",class'class',true));
...
defaultproperties
{
     ...
     HeadSize=1.000000
     HintSound=Sound'DoomMonsterPackv3.Seeker.SoulCubeSeekers'
     ...
     FadeClass=Class'DoomMonsterPackv3.Seeker_MaterialSequence'
     aimerror=10
     DodgeSkillAdjust=3.000000
     HitSound(0)=Sound'DoomMonsterPackv3.Seeker.seeker1'
     HitSound(1)=Sound'DoomMonsterPackv3.Seeker.seeker2'
     HitSound(2)=Sound'DoomMonsterPackv3.Seeker.seeker2'
     HitSound(3)=Sound'DoomMonsterPackv3.Seeker.seeker1'
     DeathSound(0)=Sound'DoomMonsterPackv3.Seeker.seeker_die1'
     DeathSound(1)=Sound'DoomMonsterPackv3.Seeker.seeker_die2'
     DeathSound(2)=Sound'DoomMonsterPackv3.Seeker.seeker_die3'
     DeathSound(3)=Sound'DoomMonsterPackv3.Seeker.seeker_die3'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Seeker.seeker3'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Seeker.seeker4'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Seeker.seeker4'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Seeker.seeker3'
     ScoringValue=5
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.SeekerMesh'
     PrePivot=(Z=-70.000000)
     Skins(0)=Texture'DoomMonsterPackv3.Seeker.Seeker_Skin'
     Skins(1)=None
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Seeker.PawnKParams'
