...
defaultproperties
{
     ...
     GroundSlamSound=Sound'DoomMonsterPackv3.Guardian.Guardian_rocksmash'
     ShockDamage=20
     ShockRadius=300.000000
     RunningMeleeAttacks(0)="RunHeadbutt"
     RunningMeleeAttacks(1)="RunHeadbutt"
     FadeTongueClass=Class'DoomMonsterPackv3.Guardian_Tongue_MaterialSequence'
     ...
     ProjectileClass(0)=Class'DoomMonsterPackv3.Guardian_Projectile'
     ProjectileClass(1)=Class'DoomMonsterPackv3.Guardian_ProjectileMouth'
     FadeClass=Class'DoomMonsterPackv3.Guardian_MaterialSequence'
     BurnAnimTime=1.200000
     aimerror=10
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Guardian.Guardian_chatter1'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Guardian.Guardian_chatter3'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Guardian.Guardian_chatter1'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Guardian.Guardian_chatter3'
     Footstep(0)=Sound'DoomMonsterPackv3.Guardian.Guardian_step4'
     Footstep(1)=Sound'DoomMonsterPackv3.Guardian.Guardian_step4'
     Footstep(2)=Sound'DoomMonsterPackv3.Guardian.Guardian_step4'
     Footstep(3)=Sound'DoomMonsterPackv3.Guardian.Guardian_step4'
     bCanDodge=False
     HitSound(0)=Sound'DoomMonsterPackv3.Guardian.Guardian_pain1'
     HitSound(1)=Sound'DoomMonsterPackv3.Guardian.Guardian_pain2'
     HitSound(2)=Sound'DoomMonsterPackv3.Guardian.Guardian_pain3'
     HitSound(3)=Sound'DoomMonsterPackv3.Guardian.Guardian_pain1'
     DeathSound(0)=Sound'DoomMonsterPackv3.Guardian.guardian_death'
     DeathSound(1)=Sound'DoomMonsterPackv3.Guardian.guardian_death'
     DeathSound(2)=Sound'DoomMonsterPackv3.Guardian.guardian_death'
     DeathSound(3)=Sound'DoomMonsterPackv3.Guardian.guardian_death'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Guardian.Guardian_chatter_combat2'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Guardian.guardian_sight'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Guardian.Guardian_sight2_1'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Guardian.Guardian_sight1_1'
     FireSound=Sound'DoomMonsterPackv3.Guardian.guardian_fire_flare_up'
     ScoringValue=15
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.GuardianMesh'
     PrePivot=(X=-50.000000,Z=-115.000000)
     Skins(0)=Texture'DoomMonsterPackv3.Guardian.Guardian_Tongue_Skin'
     Skins(1)=Texture'DoomMonsterPackv3.Guardian.Guardian_Skin'
     Skins(2)=Shader'DoomMonsterPackv3.Guardian.Guardian_Skin_Shader'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Guardian.PawnKParams'
