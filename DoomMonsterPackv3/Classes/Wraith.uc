...
defaultproperties
{
     TeleportIn=Sound'DoomMonsterPackv3.Wraith.Wraith_teleport_in_01'
     TeleportOut=Sound'DoomMonsterPackv3.Wraith.Wraith_teleport_out_01'
     bWraithCanTeleport=True
     TeleportIntervalTime=2.200000
     BurnClassTwo=Class'DoomMonsterPackv3.Wraith_Wing_FinalBlend'
     ...
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Wraith.Wraith_Attack1'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Wraith.Wraith_Attack2'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Wraith.Wraith_Attack3'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Wraith.Wraith_Attack1'
     Footstep(0)=Sound'DoomMonsterPackv3.Wraith.Wraith_footstep1'
     Footstep(1)=Sound'DoomMonsterPackv3.Wraith.Wraith_footstep2'
     Footstep(2)=Sound'DoomMonsterPackv3.Wraith.Wraith_footstep3'
     Footstep(3)=Sound'DoomMonsterPackv3.Wraith.Wraith_footstep4'
     HitSound(0)=Sound'DoomMonsterPackv3.Wraith.Wraith_Pain'
     HitSound(1)=Sound'DoomMonsterPackv3.Wraith.Wraith_Pain_Chest'
     HitSound(2)=Sound'DoomMonsterPackv3.Wraith.Wraith_pain_left_arm'
     HitSound(3)=Sound'DoomMonsterPackv3.Wraith.Wraith_pain_right_arm'
     DeathSound(0)=Sound'DoomMonsterPackv3.Wraith.Wraith_Death'
     DeathSound(1)=Sound'DoomMonsterPackv3.Wraith.Wraith_death_04'
     DeathSound(2)=Sound'DoomMonsterPackv3.Wraith.Wraith_death_03'
     DeathSound(3)=Sound'DoomMonsterPackv3.Wraith.Wraith_death_02'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Wraith.Wraith_chatter1'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Wraith.Wraith_chatter2'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Wraith.Wraith_chatter3'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Wraith.Wraith_chatter4'
     ScoringValue=15
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.WraithMesh'
     DrawScale=1.300000
     PrePivot=(Z=-30.000000)
     Skins(0)=Texture'DoomMonsterPackv3.Effects.Invis_Mat'
     Skins(1)=Shader'DoomMonsterPackv3.Wraith.Wraith_Wing_Shader'
     Skins(2)=Texture'DoomMonsterPackv3.Wraith.Wraith_Skin'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Wraith.PawnKParams'
