...
defaultproperties
{
     ...
     SpeciesName="None"
     bCanLunge=True
     BurnClass=Class'DoomMonsterPackv3.Doom_FinalBlend'
     FadeClass=Class'DoomMonsterPackv3.Doom_MaterialSequence'
     BurnDustClass=Class'DoomMonsterPackv3.Doom_Dust_Medium'
     SpawnFXClass=Class'DoomMonsterPackv3.Doom_SpawnEffect'
     InvisMat=Texture'DoomMonsterPackv3.Effects.Invis_Mat'
     BurnAnimTime=1.000000
     MinTimeBetweenPainAnims=3.000000
     TeleportRadius=1000.000000
     BurnSpeed=1
     MissSound(0)=Sound'DoomMonsterPackv3.Imp.imp_miss_01'
     MissSound(1)=Sound'DoomMonsterPackv3.Imp.imp_miss_03'
     MissSound(2)=Sound'DoomMonsterPackv3.Imp.imp_miss_01'
     MissSound(3)=Sound'DoomMonsterPackv3.Imp.imp_miss_03'
     DodgeSkillAdjust=1.000000
     Species=Class'DoomMonsterPackv3.Doom_Species'
