...
defaultproperties
{
     ChargeSound=Sound'DoomMonsterPackv3.LostSoul.LostSoul_charge_01'
     ...
     DeathAnims(3)="Pain02"
     TauntAnim="Sight"
     FadeClass=Class'DoomMonsterPackv3.LostSoul_MaterialSequence'
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_attack_02'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_attack_02'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_attack_02'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_attack_02'
     bCanDodge=False
     DodgeSkillAdjust=4.000000
     HitSound(0)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_pain_01'
     HitSound(1)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_pain_02'
     HitSound(2)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_pain_01'
     HitSound(3)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_pain_02'
     DeathSound(0)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_death_01'
     DeathSound(1)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_death_02'
     DeathSound(2)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_death_04'
     DeathSound(3)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_death_04'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_chatter_01'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_chatter_02'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_sight_02'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.LostSoul.LostSoul_sight_03'
     ScoringValue=5
     ...
     Mesh=SkeletalMesh'DoomMonsterPackv3.LostSoulMesh'
     DrawScale=2.500000
     PrePivot=(Z=0.000000)
     Skins(0)=Shader'DoomMonsterPackv3.Lost.LostSoul_Teeth_Shader'
     Skins(1)=Texture'DoomMonsterPackv3.Lost.LostSoul_Skin'
     Skins(2)=Shader'DoomMonsterPackv3.Lost.LostSoul_FXShader'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.LostSoul.PawnKParams'
