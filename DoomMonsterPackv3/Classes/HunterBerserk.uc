...
defaultproperties
{
     ...
     PreFireSound=Sound'DoomMonsterPackv3.Hunter.Hunter_fb_prefire_01'
     ...
     ProjectileClass(0)=Class'DoomMonsterPackv3.HunterBerserk_Projectile'
     ProjectileClass(1)=Class'DoomMonsterPackv3.HunterBerserk_Projectile'
     FadeClass=Class'DoomMonsterPackv3.HunterBerserk_MaterialSequence'
     ...
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Hunter.Hunter_mono_growl_25'
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.HunterBerserkMesh'
     DrawScale=1.200000
     PrePivot=(X=-5.000000,Z=-80.000000)
     Skins(0)=Texture'DoomMonsterPackv3.HunterBerserk.HunterBerserk_Skin'
     Skins(1)=Texture'DoomMonsterPackv3.HunterBerserk.HunterBerserk_Claws_Skin'
     Skins(2)=Shader'DoomMonsterPackv3.HunterBerserk.HunterBerserk_Heart_Shader'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.HunterBerserk.PawnKParams'
