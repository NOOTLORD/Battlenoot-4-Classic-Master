...
defaultproperties
{
     ...
     FadeClassTwo=Class'DoomMonsterPackv3.HunterHellTime_Meat_MaterialSequence'
     ChestRipSound(0)=Sound'DoomMonsterPackv3.Hunter.Hunter_chestrip_01'
     ChestRipSound(1)=Sound'DoomMonsterPackv3.Hunter.Hunter_chestrip_03'
     ChestRipSound(2)=Sound'DoomMonsterPackv3.Hunter.Hunter_chestrip_04'
     PreFireSound=Sound'DoomMonsterPackv3.Hunter.Hunter_helltime_summon'
     TeleportSound=Sound'DoomMonsterPackv3.Hunter.Hunter_helltime_teleport1'
     TeleportStart=Sound'DoomMonsterPackv3.Hunter.Hunter_helltime_tpstart'
     ...
     DeathAnims(3)="DeathB"
     TauntAnim="Sight"
     ProjectileClass(0)=Class'DoomMonsterPackv3.HunterHellTime_Projectile'
     ProjectileClass(1)=Class'DoomMonsterPackv3.HunterHellTime_ProjectileLesser'
     FadeClass=Class'DoomMonsterPackv3.HunterHellTime_MaterialSequence'
     BurnAnimTime=0.250000
     TeleportRadius=1500.000000
     aimerror=10
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Hunter.Hunter_attack_01'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Hunter.Hunter_attack_07'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Hunter.Hunter_attack_09'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Hunter.Hunter_attack_11'
     Footstep(0)=Sound'DoomMonsterPackv3.HellKnight.HellKnight_step1'
     Footstep(1)=Sound'DoomMonsterPackv3.HellKnight.HellKnight_step1'
     Footstep(2)=Sound'DoomMonsterPackv3.HellKnight.HellKnight_step1'
     Footstep(3)=Sound'DoomMonsterPackv3.HellKnight.HellKnight_step1'
     DodgeSkillAdjust=2.000000
     HitSound(0)=Sound'DoomMonsterPackv3.Hunter.Hunter_pain_01'
     HitSound(1)=Sound'DoomMonsterPackv3.Hunter.Hunter_pain_02'
     HitSound(2)=Sound'DoomMonsterPackv3.Hunter.Hunter_pain_06'
     HitSound(3)=Sound'DoomMonsterPackv3.Hunter.Hunter_pain_08'
     DeathSound(0)=Sound'DoomMonsterPackv3.Hunter.Hunter_death_03'
     DeathSound(1)=Sound'DoomMonsterPackv3.Hunter.Hunter_death_05'
     DeathSound(2)=Sound'DoomMonsterPackv3.Hunter.Hunter_death_03'
     DeathSound(3)=Sound'DoomMonsterPackv3.Hunter.Hunter_death_05'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Hunter.Hunter_helltime_chatter_03'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Hunter.Hunter_sight_01'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Hunter.Hunter_mono_growl_03'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Hunter.Hunter_mono_growl_27'
     FireSound=Sound'DoomMonsterPackv3.Hunter.Hunter_fb_prefire_03'
     ScoringValue=15
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.HunterHellTimeMesh'
     DrawScale=1.200000
     PrePivot=(X=-10.000000,Z=-70.000000)
     Skins(0)=Texture'DoomMonsterPackv3.HunterHellTime.HunterHellTime_Meat_Skin'
     Skins(1)=Texture'DoomMonsterPackv3.HunterHellTime.HunterHellTime_Skin'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.HunterHellTime.PawnKParams'
