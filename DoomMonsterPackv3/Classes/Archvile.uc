	...
	if(bArchvileCanSummon && NumMinions() < SummonMonsterLimit && Level.TimeSeconds - LastSummonTime > SummonIntervalTime)
	{
		...
		if(MonsterClass != None)
		{
			...
			if(Summoned != None)
			{
				...
				InvClass = class<Inventory>(DynamicLoadObject("DoomMonsterPackv3.Archvile_Inventory",class'class',true));
...
defaultproperties
{
     ResurrectionSound=Sound'DoomMonsterPackv3.Archvile.Archvile_Resurrection'
     BurnSounds(0)=Sound'DoomMonsterPackv3.Archvile.Archvile_fire_01'
     BurnSounds(1)=Sound'DoomMonsterPackv3.Archvile.Archvile_fire_02'
     BurnSounds(2)=Sound'DoomMonsterPackv3.Archvile.Archvile_fire_04'
     ...
     SummonMonsterClass(0)="DoomMonsterPackv3.Tick_Weak"
     SummonMonsterClass(1)="DoomMonsterPackv3.Trite_Weak"
     SummonMonsterClass(2)="DoomMonsterPackv3.Cherub_Weak"
     SummonMonsterClass(3)="DoomMonsterPackv3.LostSoul_Weak"
     ...
     ProjectileClass(0)=Class'DoomMonsterPackv3.Archvile_Projectile'
     ProjectileClass(1)=Class'DoomMonsterPackv3.Archvile_ProjectileFirewall'
     FadeClass=Class'DoomMonsterPackv3.Archvile_MaterialSequence'
     BurnAnimTime=0.250000
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight12'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight12'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight12'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight12'
     Footstep(0)=Sound'DoomMonsterPackv3.Archvile.Archvile_step4'
     Footstep(1)=Sound'DoomMonsterPackv3.Archvile.Archvile_step2'
     Footstep(2)=Sound'DoomMonsterPackv3.Archvile.Archvile_step4'
     Footstep(3)=Sound'DoomMonsterPackv3.Archvile.Archvile_step2'
     HitSound(0)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight11'
     HitSound(1)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight11'
     HitSound(2)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight11'
     HitSound(3)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight11'
     DeathSound(0)=Sound'DoomMonsterPackv3.Archvile.Archvile_die4'
     DeathSound(1)=Sound'DoomMonsterPackv3.Archvile.Archvile_die4'
     DeathSound(2)=Sound'DoomMonsterPackv3.Archvile.Archvile_die4'
     DeathSound(3)=Sound'DoomMonsterPackv3.Archvile.Archvile_die4'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Archvile.Archvile_cin_sight'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Archvile.Archvile_cin_sight'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight2_1'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Archvile.Archvile_sight2_2'
     FireSound=Sound'DoomMonsterPackv3.Archvile.Archvile_burn'
     ScoringValue=8
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.ArchvileMesh'
     DrawScale=1.200000
     PrePivot=(Z=-58.000000)
     Skins(0)=Texture'DoomMonsterPackv3.Archvile.Archvile_Skin'
     Skins(1)=Shader'DoomMonsterPackv3.Archvile.Archvile_Hand_Shader'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Archvile.PawnKParams'
