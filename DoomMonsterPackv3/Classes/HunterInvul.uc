...
defaultproperties
{
     ...
     ShockWaveDamageType=Class'DoomMonsterPackv3.DamType_HunterInvul_ShockWave'
     ...
     ProjectileClass(0)=Class'DoomMonsterPackv3.HunterInvul_Projectile'
     ProjectileClass(1)=Class'DoomMonsterPackv3.HunterInvul_ProjectileBig'
     FadeClass=Class'DoomMonsterPackv3.HunterInvul_MaterialSequence'
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.HunterInvulMesh'
     DrawScale=1.200000
     PrePivot=(X=-5.000000,Z=-80.000000)
     Skins(0)=Shader'DoomMonsterPackv3.HunterInvulnerable.HunterInvul_Skin_Shader'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.HunterInvul.PawnKParams'
