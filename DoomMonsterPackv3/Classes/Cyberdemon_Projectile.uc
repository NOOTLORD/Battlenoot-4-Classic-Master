...
defaultproperties
{
     ...
     TrailClass=Class'DoomMonsterPackv3.Cyberdemon_ProjectileTrail'
     Explosionclass=Class'DoomMonsterPackv3.Cyberdemon_ProjectileExplosion'
     bSeeking=True
     Speed=900.000000
     ...
     MyDamageType=Class'DoomMonsterPackv3.DamType_Cyberdemon_Projectile'
