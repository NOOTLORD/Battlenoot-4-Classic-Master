...
defaultproperties
{
     ...
     DeathAnims(3)="DeathF"
     TauntAnim="Sight"
     FadeClass=Class'DoomMonsterPackv3.Trite_MaterialSequence'
     BurnDustClass=Class'DoomMonsterPackv3.Doom_Dust_Small'
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Trite.Trite_attack18'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Trite.Trite_chomp1'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Trite.Trite_attack13'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Trite.Trite_attack11'
     Footstep(0)=Sound'DoomMonsterPackv3.Trite.trite_walk1'
     Footstep(1)=Sound'DoomMonsterPackv3.Trite.trite_walk2'
     Footstep(2)=Sound'DoomMonsterPackv3.Trite.trite_walk3'
     Footstep(3)=Sound'DoomMonsterPackv3.Trite.trite_walk4'
     DodgeSkillAdjust=4.000000
     HitSound(0)=Sound'DoomMonsterPackv3.Trite.Trite_pain13'
     HitSound(1)=Sound'DoomMonsterPackv3.Trite.Trite_pain21'
     HitSound(2)=Sound'DoomMonsterPackv3.Trite.Trite_pain22'
     HitSound(3)=Sound'DoomMonsterPackv3.Trite.Trite_pain10'
     DeathSound(0)=Sound'DoomMonsterPackv3.Trite.Trite_death21'
     DeathSound(1)=Sound'DoomMonsterPackv3.Trite.Trite_Death22'
     DeathSound(2)=Sound'DoomMonsterPackv3.Trite.Trite_death23'
     DeathSound(3)=Sound'DoomMonsterPackv3.Trite.Trite_death21'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Trite.Trite_sight3'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Trite.Trite_sight11'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Trite.Trite_sight13'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Trite.Trite_sight5'
     ScoringValue=5
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.TriteMesh'
     DrawScale=1.800000
     PrePivot=(Z=-30.000000)
     Skins(0)=Texture'DoomMonsterPackv3.Trite.Trite_Skin'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Trite.PawnKParams'
