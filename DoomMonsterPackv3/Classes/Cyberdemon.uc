...
defaultproperties
{
     WeaponFlashLight(0)=Shader'DoomMonsterPackv3.Cyberdemon.CyberDemon_WeaponTipGlow_Shader'
     WeaponFlashLight(1)=Shader'DoomMonsterPackv3.Cyberdemon.CyberDemon_Flash_Shader'
     WeaponFlashLight(2)=Shader'DoomMonsterPackv3.Cyberdemon.CyberDemon_WeaponTipGlow_Shader'
     WeaponFlashLight(3)=Shader'DoomMonsterPackv3.Cyberdemon.CyberDemon_WeaponTipGlow_Shader'
     RocketSounds(0)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_rocket_fire_01'
     RocketSounds(1)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_rocket_fire_03'
     RocketSounds(2)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_rocket_fire_04'
     ...
     ProjectileClass(0)=Class'DoomMonsterPackv3.Cyberdemon_Projectile'
     ProjectileClass(1)=Class'DoomMonsterPackv3.Cyberdemon_Projectile'
     FadeClass=Class'DoomMonsterPackv3.Cyberdemon_MaterialSequence'
     BurnAnimTime=0.150000
     MissSound(0)=None
     MissSound(1)=None
     MissSound(2)=None
     MissSound(3)=None
     Footstep(0)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_step2'
     Footstep(1)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_step3'
     Footstep(2)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_step2'
     Footstep(3)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_step3'
     bMeleeFighter=False
     bCanDodge=False
     DodgeSkillAdjust=0.100000
     HitSound(0)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_pain1'
     HitSound(1)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_pain2'
     HitSound(2)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_pain3'
     HitSound(3)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_pain4'
     DeathSound(0)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_sight3'
     DeathSound(1)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_sight2'
     DeathSound(2)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_sight3'
     DeathSound(3)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_sight2'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_sight1'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_chatter2'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_chatter1'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Cyberdemon.CyberDemon_sight1'
     ScoringValue=15
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     Mesh=SkeletalMesh'DoomMonsterPackv3.CyberDemonMesh'
     DrawScale=1.200000
     PrePivot=(Z=-125.000000)
     Skins(0)=Texture'DoomMonsterPackv3.Cyberdemon.CyberDemon_Skin'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Cyberdemon.PawnKParams'
