...
defaultproperties
{
     ChargeSound=Sound'DoomMonsterPackv3.Forgotten.Forgotten_sight_01'
     ...
     DeathAnims(3)="Pain02"
     TauntAnim="Sight"
     FadeClass=Class'DoomMonsterPackv3.Forgotten_MaterialSequence'
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_chomp_01'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_chomp_02'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_chomp_03'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_chomp_01'
     bCanDodge=False
     DodgeSkillAdjust=4.000000
     HitSound(0)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_pain_03'
     HitSound(1)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_pain_04'
     HitSound(2)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_pain_03'
     HitSound(3)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_pain_04'
     DeathSound(0)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_death_01'
     DeathSound(1)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_death_05'
     DeathSound(2)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_death_01'
     DeathSound(3)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_death_05'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_sight_02'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_sight_03'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_idle_01'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Forgotten.Forgotten_idle_03'
     ScoringValue=5
     ...
     IdleRestAnim="Idle"
     IdleChatAnim="Idle"
     AmbientSound=Sound'DoomMonsterPackv3.Forgotten.Forgotten_flight_02a'
     Mesh=SkeletalMesh'DoomMonsterPackv3.ForgottenMesh'
     DrawScale=2.500000
     PrePivot=(Z=-20.000000)
     Skins(0)=Texture'DoomMonsterPackv3.Forgotten.Forgotten_Skin'
     Skins(1)=Shader'DoomMonsterPackv3.Forgotten.Forgotten_Flames_Shader'
     Skins(2)=FinalBlend'DoomMonsterPackv3.Forgotten.Forgotten_Skin_FinalBlend'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Forgotten.PawnKParams'
