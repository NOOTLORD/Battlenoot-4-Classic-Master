...
defaultproperties
{
     ...
     AsteroidSpawnSounds(0)=Sound'DoomMonsterPackv3.Maledict.Maledict_fire_05'
     AsteroidSpawnSounds(1)=Sound'DoomMonsterPackv3.Maledict.Maledict_fire_02'
     OtherSpawnSpawns(0)=Sound'DoomMonsterPackv3.Maledict.Maledict_firestarter_01'
     OtherSpawnSpawns(1)=Sound'DoomMonsterPackv3.Maledict.Maledict_firestarter_02'
     OtherSpawnSpawns(2)=Sound'DoomMonsterPackv3.Maledict.Maledict_firestarter_03'
     OtherSpawnSpawns(3)=Sound'DoomMonsterPackv3.Maledict.Maledict_firestarter_04'
     ChargeSound(0)=Sound'DoomMonsterPackv3.Maledict.Maledict_whoosh_01'
     ChargeSound(1)=Sound'DoomMonsterPackv3.Maledict.Maledict_whoosh_02'
     ...
     ProjectileClass(0)=Class'DoomMonsterPackv3.Maledict_Projectile'
     ProjectileClass(1)=Class'DoomMonsterPackv3.Maledict_ProjectileBig'
     BurnClass=Class'DoomMonsterPackv3.Maledict_FinalBlend'
     BurnAnimTime=0.500000
     aimerror=100
     MeleeAttackSounds(0)=Sound'DoomMonsterPackv3.Maledict.Maledict_whoosh_01'
     MeleeAttackSounds(1)=Sound'DoomMonsterPackv3.Maledict.Maledict_whoosh_02'
     MeleeAttackSounds(2)=Sound'DoomMonsterPackv3.Maledict.Maledict_whoosh_01'
     MeleeAttackSounds(3)=Sound'DoomMonsterPackv3.Maledict.Maledict_whoosh_02'
     bMeleeFighter=False
     DodgeSkillAdjust=4.000000
     HitSound(0)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_05'
     HitSound(1)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_05'
     HitSound(2)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_05'
     HitSound(3)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_05'
     DeathSound(0)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_10'
     DeathSound(1)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_14'
     DeathSound(2)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_18'
     DeathSound(3)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_19'
     ChallengeSound(0)=Sound'DoomMonsterPackv3.Maledict.Maledict_Scream_01'
     ChallengeSound(1)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_04'
     ChallengeSound(2)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_07'
     ChallengeSound(3)=Sound'DoomMonsterPackv3.Maledict.Maledict_scream_09'
     ScoringValue=15
     ...
     AmbientSound=Sound'DoomMonsterPackv3.LostSoul.LostSoul_idle_01'
     Mesh=SkeletalMesh'DoomMonsterPackv3.MaledictMesh'
     DrawScale=0.700000
     PrePivot=(X=-30.000000)
     Skins(0)=Shader'DoomMonsterPackv3.Maledict.Maledict_Skin_Shader'
     Skins(1)=Texture'DoomMonsterPackv3.Effects.Invis_Mat'
     Skins(2)=Texture'DoomMonsterPackv3.Effects.Invis_Mat'
     Skins(3)=Shader'DoomMonsterPackv3.Maledict.Maledict_Teeth_Shader'
     Skins(4)=Shader'DoomMonsterPackv3.Maledict.MaledictSkullShader'
     ...
     End Object
     KParams=KarmaParamsSkel'DoomMonsterPackv3.Maledict.PawnKParams'
