...
//=============================================================================
class SAR12Rifle extends BallisticWeapon;
...
defaultproperties
{
     ...
     BigIconMaterial=Texture'BallisticProUITex.Icons.BigIcon_SAR-12'
     BigIconCoords=(Y1=24,Y2=250)
     BCRepClass=Class'BallisticProV55.BallisticReplicationInfo'
     SightFXClass=Class'BallisticProV55.SAR12SightDot'
     bWT_Machinegun=True
     InventorySize=12	 
     ...
     CockSound=(Sound=Sound'BallisticProSounds.SAR-12.SAR-12-Cock',Volume=0.900000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ReloadAnimRate=1.100000
     ClipOutSound=(Sound=Sound'BallisticProSounds.SAR-12.SAR-12-ClipOut',Volume=0.900000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ClipInSound=(Sound=Sound'BallisticProSounds.SAR-12.SAR-12-ClipIn',Volume=0.900000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ...
     Priority=32	 
     FireModeClass(0)=Class'BallisticProV55.SAR12PrimaryFire'
     FireModeClass(1)=Class'BCoreProV55.BallisticScopeFire'
	 AIRating=0.720000
	 CurrentRating=0.720000	 
     AmmoClass(0)=Class'BallisticProV55.Ammo_SAR12Rifle'
     AmmoClass(1)=Class'BallisticProV55.Ammo_SAR12Rifle'	 
     Description="SAR-12"
     CustomCrossHairScale=0.000000
     CustomCrossHairTextureName="Crosshairs.HUD.Crosshair_Cross1"	 
     InventoryGroup=1 
     PlayerViewOffset=(X=14.000000,Y=13.500000,Z=-11.000000)
     AttachmentClass=Class'BallisticProV55.SAR12Attachment'
     IconMaterial=Texture'BallisticProUITex.Icons.SmallIcon_SAR-12'
     ...
     Mesh=SkeletalMesh'BallisticProAnims.SAR-12_FP'
     DrawScale=0.300000
	 Skins(0)=Shader'BallisticProTex.Hands.Hands-Shiny'
	 Skins(1)=Texture'BallisticProTex.SAR-12.SAR-12-Main'
	 Skins(2)=Texture'BallisticProTex.SAR-12.SAR-12-SightCross'
