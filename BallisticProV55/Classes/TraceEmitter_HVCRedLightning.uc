//=============================================================================
// TraceEmitter_HVCRedLightning.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class TraceEmitter_HVCRedLightning extends BCTraceEmitter;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter0
         ...
         Texture=Texture'BWBP2-FX.Particles.LightningBolt2'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=0.800000,Max=0.800000)
         StartVelocityRange=(X=(Min=1.000000,Max=1.000000))
     End Object
     Emitters(0)=BeamEmitter'BallisticProV55.TraceEmitter_HVCRedLightning.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.135714,Color=(B=64,R=64,A=255))
         ColorScale(2)=(RelativeTime=0.260714,Color=(B=64,G=192,R=255,A=255))
     ...
     End Object
     Emitters(1)=BeamEmitter'BallisticProV55.TraceEmitter_HVCRedLightning.BeamEmitter1'
     ...
     End Object
     Emitters(2)=SpriteEmitter'BallisticProV55.TraceEmitter_HVCRedLightning.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         LifetimeRange=(Min=0.800000,Max=0.800000)
     End Object
     Emitters(3)=SpriteEmitter'BallisticProV55.TraceEmitter_HVCRedLightning.SpriteEmitter1'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter3
         ...
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.142857,Color=(B=64,R=64,A=255))
         ColorScale(2)=(RelativeTime=0.260714,Color=(B=192,G=224,R=255,A=255))
         ColorScale(3)=(RelativeTime=0.382143,Color=(B=64,R=64,A=255))
         ColorScale(4)=(RelativeTime=0.485714,Color=(B=128,G=192,R=255,A=255))
         ColorScale(5)=(RelativeTime=1.000000,Color=(R=255,A=255))
         ...
         StartVelocityRange=(X=(Min=1.000000,Max=1.000000))
     End Object
     Emitters(4)=BeamEmitter'BallisticProV55.TraceEmitter_HVCRedLightning.BeamEmitter3'
