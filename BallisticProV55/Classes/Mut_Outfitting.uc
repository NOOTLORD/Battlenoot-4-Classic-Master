...
defaultproperties
{
     ...
     LoadOut(1)="BallisticProV55.D49Revolver"
     LoadOut(2)="BallisticProV55.XMK5SubMachinegun"
     LoadOut(3)="BWBPOtherPackPro.CX61AssaultRifle"
     LoadOut(4)="BallisticProV55.NRP57Grenade"
     Killstreaks(0)="BWBPRecolorsPro.MGLauncher"
     Killstreaks(1)="BallisticProV55.XMV850Minigun"
     bAllowKillstreaks=True
     LoadoutGroup0(0)="BallisticProV55.X4Knife"
     LoadoutGroup1(0)="BWBPRecolorsPro.AH208Pistol"
     LoadoutGroup1(1)="BWBPRecolorsPro.MRDRMachinePistol"
     LoadoutGroup1(2)="BallisticProV55.D49Revolver"
     LoadoutGroup1(3)="BallisticProV55.MD24Pistol"
     LoadoutGroup1(4)="BallisticProV55.RS8Pistol"
     LoadoutGroup1(5)="BallisticProV55.Fifty9MachinePistol"
     LoadoutGroup1(6)="BallisticProV55.XRS10SubMachinegun"
     LoadoutGroup2(0)="BallisticProV55.XK2SubMachinegun"
     LoadoutGroup2(1)="BallisticProV55.XMK5SubMachinegun"
     LoadoutGroup2(2)="BWBPOtherPackPro.CX61AssaultRifle"
     LoadoutGroup2(3)="BWBPRecolorsPro.AK47AssaultRifle"
     LoadoutGroup2(4)="BWBPRecolorsPro.F2000AssaultRifle"
     LoadoutGroup2(5)="BWBPRecolorsPro.LK05Carbine"
     LoadoutGroup2(6)="BallisticProV55.M46AssaultRifleQS"
     LoadoutGroup2(7)="BallisticProV55.SARAssaultRifle"
     LoadoutGroup2(8)="BallisticProV55.M50AssaultRifle"
     LoadoutGroup2(9)="BWBPRecolorsPro.SK410Shotgun"
     LoadoutGroup2(10)="BallisticProV55.M763Shotgun"
     LoadoutGroup2(11)="BallisticProV55.MRS138Shotgun"
     LoadoutGroup2(12)="BallisticProV55.R78Rifle"
     LoadoutGroup2(13)="BallisticProV55.MarlinRifle"
     LoadoutGroup2(14)="BallisticProV55.SRS900Rifle"
     LoadoutGroup3(0)="BWBPRecolorsPro.SK410Shotgun"
     LoadoutGroup3(1)="BallisticProV55.M763Shotgun"
     LoadoutGroup3(2)="BallisticProV55.MRS138Shotgun"
     LoadoutGroup3(3)="BWBPRecolorsPro.F2000AssaultRifle"
     LoadoutGroup3(4)="BWBPRecolorsPro.LK05Carbine"
     LoadoutGroup3(5)="BallisticProV55.M46AssaultRifleQS"
     LoadoutGroup3(6)="BallisticProV55.M50AssaultRifle"
     LoadoutGroup3(7)="BallisticProV55.SARAssaultRifle"
     LoadoutGroup3(8)="BWBPOtherPackPro.CX61AssaultRifle"
     LoadoutGroup3(9)="BWBPRecolorsPro.AK47AssaultRifle"
     LoadoutGroup3(10)="BallisticProV55.XK2SubMachinegun"
     LoadoutGroup3(11)="BallisticProV55.XMK5SubMachinegun"
     LoadoutGroup3(12)="BallisticProV55.MarlinRifle"
     LoadoutGroup3(13)="BallisticProV55.R78Rifle"
     LoadoutGroup3(14)="BallisticProV55.SRS900Rifle"
     LoadoutGroup4(0)="BallisticProV55.G5Bazooka"
     LoadoutGroup4(1)="BallisticProV55.NRP57Grenade"
     LoadoutGroup4(2)="BallisticProV55.BX5Mine"
     bHideLockers=True
