...
//=============================================================================
class XK2SMG extends BallisticWeapon;
...
defaultproperties
{
     ...
     BigIconMaterial=Texture'BallisticProUITex.Icons.BigIcon_XK2'
     BigIconCoords=(X1=24,X2=450)
     BCRepClass=Class'BallisticProV55.BallisticReplicationInfo'
     bWT_Machinegun=True
     InventorySize=12	 
     SpecialInfo(0)=(Info="120.0;10.0;0.6;60.0;0.3;0.1;-999.0")
     BringUpSound=(Sound=Sound'BallisticProSounds.XK2.XK2-Pullout',Volume=0.350000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     PutDownSound=(Sound=Sound'BallisticProSounds.XK2.XK2-Putaway',Volume=0.350000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     MagAmmo=40	
	 CockAnimRate=1.250000	 
     CockSound=(Sound=Sound'BallisticProSounds.XK2.XK2-Cock',Volume=0.850000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True) 
     ClipHitSound=(Volume=0.600000)
     ClipOutSound=(Sound=Sound'BallisticProSounds.XK2.XK2-ClipOut',Volume=0.850000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ClipInSound=(Sound=Sound'BallisticProSounds.XK2.XK2-ClipIn',Volume=0.850000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ...
     AmmoClass(0)=Class'BallisticProV55.Ammo_XK2SMG'
     AmmoClass(1)=Class'BallisticProV55.Ammo_XK2SMG'	 
     Description="XK2"
     ...
     Mesh=SkeletalMesh'BallisticProAnims.XK2_FP'
     DrawScale=0.200000
