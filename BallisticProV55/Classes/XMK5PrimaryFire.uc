//=============================================================================
// Primaryfire class for the XMK-5 SMG
//
...
defaultproperties
{
     ...
     DamageType=Class'BallisticProV55.DT_XMK5Body'
     DamageTypeHead=Class'BallisticProV55.DT_XMK5Head'
     DamageTypeArm=Class'BallisticProV55.DT_XMK5Body'
     ...
     BallisticFireSound=(Sound=Sound'BallisticProSounds.XMK-5.XMK-5-Fire',Volume=1.250000,Slot=SLOT_Interact,bNoOverride=False)
     bPawnRapidFireAnim=True
     FireRate=0.100000
     AmmoClass=Class'BallisticProV55.Ammo_XMK5SMG'
