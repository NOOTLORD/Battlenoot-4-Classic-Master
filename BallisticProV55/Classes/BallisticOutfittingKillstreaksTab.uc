//=============================================================================
// BallisticOutfittingKillstreaksTab
...
//=============================================================================
class BallisticOutfittingKillstreaksTab extends UT2K4TabPanel config(BallisticProV55);
...
function SaveStreaks()
{
		...
		if (Item_Streak1.Items.length > Item_Streak1.Index)
			class'Mut_Outfitting'.default.Killstreaks[0] = SavedStreaks[cb_Presets.GetIndex()].Weapons[0];
		if (Item_Streak2.Items.length > Item_Streak2.Index)
			class'Mut_Outfitting'.default.Killstreaks[1] = SavedStreaks[cb_Presets.GetIndex()].Weapons[1];
...
defaultproperties
{
     ...
     End Object
     Item_Streak1=GUILoadOutItem'BallisticProV55.BallisticOutfittingKillstreaksTab.Streak1Image'
     ...
     End Object
     Item_Streak2=GUILoadOutItem'BallisticProV55.BallisticOutfittingKillstreaksTab.Streak2Image'
     ...
     Begin Object Class=GUIComboBox Name=cb_Streak1ComBox
         ...
         WinHeight=0.040000
         TabOrder=0
         OnChange=BallisticOutfittingKillstreaksTab.InternalOnChange
         OnKeyEvent=cb_Streak1ComBox.InternalOnKeyEvent
     End Object
     cb_Streak1=GUIComboBox'BallisticProV55.BallisticOutfittingKillstreaksTab.cb_Streak1ComBox'
     ...
     End Object
     cb_Streak2=GUIComboBox'BallisticProV55.BallisticOutfittingKillstreaksTab.cb_Streak2Box'
     ...
     Begin Object Class=moComboBox Name=co_PresetsCB
         ...
         OnChange=BallisticOutfittingKillstreaksTab.InternalOnChange
     End Object
     cb_Presets=moComboBox'BallisticProV55.BallisticOutfittingKillstreaksTab.co_PresetsCB'
     ...
     End Object
     Box_Streak1=GUIImage'BallisticProV55.BallisticOutfittingKillstreaksTab.ImageBoxStreak1'
     ...
     Begin Object Class=GUIImage Name=ImageBoxStreak2
         ...
         RenderWeight=0.002000
     End Object
     Box_Streak2=GUIImage'BallisticProV55.BallisticOutfittingKillstreaksTab.ImageBoxStreak2'
     ...
     End Object
     Streak1Back=GUIImage'BallisticProV55.BallisticOutfittingKillstreaksTab.Streak1BackImage'
     ...
     Begin Object Class=GUIImage Name=Streak2BackImage
         ...
         RenderWeight=0.003000
     End Object
     Streak2Back=GUIImage'BallisticProV55.BallisticOutfittingKillstreaksTab.Streak2BackImage'
     ...
     Begin Object Class=GUIButton Name=BSavePresetButton
         ...
         WinHeight=0.065000
         TabOrder=0
         OnClick=BallisticOutfittingKillstreaksTab.InternalOnClick
         OnKeyEvent=BSavePresetButton.InternalOnKeyEvent
     End Object
     BSavePreset=GUIButton'BallisticProV55.BallisticOutfittingKillstreaksTab.BSavePresetButton'
