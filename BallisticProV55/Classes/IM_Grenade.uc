...
//=============================================================================
class IM_Grenade extends BCImpactManager;
...
simulated function SpawnEffects (int HitSurfaceType, vector Norm, optional byte Flags)
{
	...
	if (PhysicsVolume.bWaterVolume)
	{
		...
		if (ImpactDepth > MinFluidDepth)
		{
			...
			HitSounds[0]=SoundGroup'BallisticProSounds.Effects.Explosion-UW';
		}
	}
...
defaultproperties
{
     ...
     HitSounds(0)=SoundGroup'BallisticProSounds.Effects.Explosion-Small'
