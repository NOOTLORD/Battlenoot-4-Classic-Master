...
defaultproperties
{
     ...
     DryFireSound=(Sound=Sound'BallisticSounds3.Misc.DryRifle',Volume=0.7500000)	 
     KickForce=0
     PenetrateForce=0
     bPenetrate=False			   					 					
     ...
     BallisticFireSound=(Sound=Sound'BallisticSounds2.M763.M763Fire1',Volume=1.350000)
     FireAnim="FireCombined"
     FireEndAnim=
