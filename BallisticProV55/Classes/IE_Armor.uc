...
//=============================================================================
class IE_Armor extends BallisticEmitter
	placeable;
...
defaultproperties
{
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         Texture=Texture'BallisticProEffectsTex.Particles.Smoke2'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=2.000000,Max=2.000000)
         StartVelocityRange=(X=(Max=15.000000),Y=(Min=-5.000000,Max=5.000000),Z=(Min=-5.000000,Max=5.000000))
     End Object
     Emitters(0)=SpriteEmitter'BallisticProV55.IE_Armor.SpriteEmitter4'
     ...
     Begin Object Class=SparkEmitter Name=SparkEmitter0
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.700000),Z=(Min=0.700000))
         FadeOutStartTime=0.130000
         FadeInEndTime=0.055000
         CoordinateSystem=PTCS_Relative
         MaxParticles=30
         InitialParticlesPerSecond=9999999.000000
         Texture=Texture'BallisticProEffectsTex.Effects.Bullet'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=0.500000,Max=0.500000)
         StartVelocityRange=(X=(Max=300.000000),Y=(Min=-100.000000,Max=100.000000),Z=(Min=-100.000000,Max=100.000000))
     End Object
     Emitters(1)=SparkEmitter'BallisticProV55.IE_Armor.SparkEmitter0'
     ...
     End Object
     Emitters(2)=SpriteEmitter'BallisticProV55.IE_Armor.SpriteEmitter5'
     ...
     End Object
     Emitters(3)=SpriteEmitter'BallisticProV55.IE_Armor.SpriteEmitter6'
