...
//=============================================================================
class DTT10Gas extends DT_BWMiscDamage;

defaultproperties
{
     DeathStrings(0)="%o choked to death in a cloud of %k's toxic gas."
     DeathStrings(1)="%k poisoned %o to death with T10 gas."
     DeathStrings(2)="%o was greened by %k's toxic grenade."
     DeathStrings(3)="%k's toxic grenade turned %o's little piggy face green."
     DeathStrings(4)="%o breathed in the toxic fumes of %k's grenade."
