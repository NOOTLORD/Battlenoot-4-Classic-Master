//=============================================================================
// Weapon class for the XRS10 SMG
//
...
//=============================================================================
class XRS10SMG extends BallisticWeapon;
...
defaultproperties
{
     ...
     BigIconMaterial=Texture'BallisticProUITex.Icons.BigIcon_XRS10'
     ...
     MagAmmo=25
     CockSound=(Sound=Sound'BallisticProSounds.XRS-10.XRS-10-Cock',Volume=0.850000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ClipOutSound=(Sound=Sound'BallisticProSounds.XRS-10.XRS-10-Clipout',Volume=0.850000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ClipInSound=(Sound=Sound'BallisticProSounds.XRS-10.XRS-10-Clipin',Volume=0.850000,Radius=32.000000,Slot=SLOT_Interact,Pitch=1.000000,bAtten=True)
     ...
     AmmoClass(0)=Class'BallisticProV55.Ammo_XRS10SMG'
     AmmoClass(1)=Class'BallisticProV55.Ammo_XRS10SMG'	 
     ...
     IconMaterial=Texture'BallisticProUITex.Icons.SmallIcon_XRS10'
     ...
     Mesh=SkeletalMesh'BallisticProAnims.XRS-10_FP'
     DrawScale=0.200000
	 Skins(0)=Shader'BallisticProTex.Hands.Hands-Shiny'
	 Skins(1)=Texture'BallisticProTex.XRS-10.XRS-10-Main'
}
