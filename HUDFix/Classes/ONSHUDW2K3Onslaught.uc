...
//
//-----------------------------------------------------------
class ONSHUDW2K3Onslaught extends HudW2K3TeamDeathMatch
    config(user);
...
simulated function DrawNodeLabel(Canvas C, vector HUDLocation, float IconScaling, float HUDScaling, Color LabelColor, int Num)
{
	...
	if (Num > 9)
    {
		...
		for (Row=-1;Row<2;Row++)
		{
			for (Col=-1;Col<2;Col++)
			{
		        ...
		        C.DrawTile(NodeDigitsBig.DigitTexture, LabelIconSize, LabelIconSize, NodeDigitsBig.TextureCoords[TensPlace].X1, NodeDigitsBig.TextureCoords[TensPlace].Y1, NodeDigitsBig.TextureCoords[0].X2, NodeDigitsBig.TextureCoords[0].Y2);
		    }
		}
	...
	for (Row=-1;Row<2;Row++)
	{
		...
		{
		    C.SetPos(x+Col,y+Row);
		    C.DrawTile(NodeDigitsBig.DigitTexture, LabelIconSize, LabelIconSize, NodeDigitsBig.TextureCoords[Num].X1, NodeDigitsBig.TextureCoords[Num].Y1, NodeDigitsBig.TextureCoords[0].X2, NodeDigitsBig.TextureCoords[0].Y2);
		}
	}
	C.SetDrawColor(255,255,0,255);
    C.SetPos(x,y);
...
defaultproperties
{
     ...
     CoreWidgets(0)=(WidgetTexture=Texture'HUDContent.Generic.HUD',RenderStyle=STY_Alpha,TextureCoords=(X1=365,Y1=233,X2=432,Y2=313),TextureScale=0.400000,DrawPivot=DP_UpperRight,PosX=0.500000,OffsetX=-20,OffsetY=15,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=100,G=100,R=255,A=200),Tints[1]=(B=32,G=32,R=255,A=200))
     CoreWidgets(1)=(WidgetTexture=Texture'HUDContent.Generic.HUD',RenderStyle=STY_Alpha,TextureCoords=(X1=365,Y1=233,X2=432,Y2=313),TextureScale=0.400000,PosX=0.500000,OffsetX=20,OffsetY=15,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=128,A=200),Tints[1]=(B=255,G=210,R=32,A=200))
     CoreHealthWidgets(0)=(RenderStyle=STY_Alpha,MinDigitCount=1,TextureScale=0.100000,DrawPivot=DP_MiddleMiddle,PosX=0.500000,OffsetX=-215,OffsetY=215,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     CoreHealthWidgets(1)=(RenderStyle=STY_Alpha,MinDigitCount=1,TextureScale=0.100000,DrawPivot=DP_MiddleMiddle,PosX=0.500000,OffsetX=215,OffsetY=215,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     NodeDigitsBig=(DigitTexture=Texture'HUDContent.Generic.HUD',TextureCoords[0]=(X2=38,Y2=38),TextureCoords[1]=(X1=39,X2=77,Y2=38),TextureCoords[2]=(X1=78,X2=116,Y2=38),TextureCoords[3]=(X1=117,X2=155,Y2=38),TextureCoords[4]=(X1=156,X2=194,Y2=38),TextureCoords[5]=(X1=195,X2=233,Y2=38),TextureCoords[6]=(X1=234,X2=272,Y2=38),TextureCoords[7]=(X1=273,X2=311,Y2=38),TextureCoords[8]=(X1=312,X2=350,Y2=38),TextureCoords[9]=(X1=351,X2=389,Y2=38),TextureCoords[10]=(X1=390,X2=428,Y2=38))
     ...
     ScoreTeam(1)=(OffsetX=270,OffsetY=75)
     ...
     TeamSymbols(0)=(TextureScale=0.090000,OffsetX=-480,OffsetY=90)
     TeamSymbols(1)=(TextureScale=0.090000,OffsetX=480,OffsetY=90)
}
