class HudW2K3DoubleDomination extends HudW2K3TeamDeathMatch;
...
simulated function ShowTeamScorePassA(Canvas C)
{
	...
	if ( DP1 != None )
	{
		...
		if (bCorrectAspectRatio)
			Draw2DLocationDot(C, DP1.Location,0.5 - 0.04*HUDScale*(ResScaleY/ResScaleX), 0.0365*HUDScale, 0.0305*HUDScale*(ResScaleY/ResScaleX), 0.0405*HUDScale);
		else Draw2DLocationDot(C, DP1.Location,0.5 - 0.04*HUDScale, 0.0365*HUDScale, 0.0305*HUDScale*(ResScaleY/ResScaleX), 0.0405*HUDScale);
	}
	if ( DP2 != None )
	{
		C.DrawColor = GoldColor;
		if (bCorrectAspectRatio)
			Draw2DLocationDot(C, DP2.Location,0.5 + 0.026*HUDScale*(ResScaleY/ResScaleX), 0.0365*HUDScale, 0.0305*HUDScale*(ResScaleY/ResScaleX), 0.0405*HUDScale);
		else Draw2DLocationDot(C, DP2.Location,0.5 + 0.026*HUDScale*(ResScaleY/ResScaleX), 0.0365*HUDScale, 0.0305*HUDScale*(ResScaleY/ResScaleX), 0.0405*HUDScale);
	}
}
