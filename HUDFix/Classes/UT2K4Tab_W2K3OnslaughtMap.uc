...
class UT2K4Tab_W2K3OnslaughtMap extends MidGamePanel;
...
function bool InternalOnPreDraw( Canvas C )
{
	...
	local ONSHUDW2K3Onslaught ONSHUD;

	ONSHUD = ONSHUDW2K3Onslaught(PlayerOwner().myHud);
...
function DrawNodeHint( ONSHUDW2K3Onslaught HUD, ONSPowerCore Core )
{
...
function SetSelectedCore()
{
	...
	Core = ONSHUDW2K3Onslaught(PlayerOwner().myHUD).LocatePowerCore(Controller.MouseX - OnslaughtMapCenterX, Controller.MouseY - OnslaughtMapCenterY, OnslaughtMapRadius);
...
defaultproperties
{
     ...
     Begin Object Class=GUILabel Name=HelpText
         ...
         WinWidth=0.274188
     End Object
     l_HelpText=GUILabel'HUDFix.UT2K4Tab_W2K3OnslaughtMap.HelpText'
     ...
     End Object
     l_HintText=GUILabel'HUDFix.UT2K4Tab_W2K3OnslaughtMap.HintLabel'
     ...
     Begin Object Class=GUILabel Name=TeamLabel
         ...
         RenderWeight=0.520000
     End Object
     l_TeamText=GUILabel'HUDFix.UT2K4Tab_W2K3OnslaughtMap.TeamLabel'
     ...
     Begin Object Class=GUIButton Name=LinkDesignButton
         ...
         RenderWeight=0.520000
         TabOrder=3
         OnClick=UT2K4Tab_W2K3OnslaughtMap.InternalOnClick
         OnKeyEvent=LinkDesignButton.InternalOnKeyEvent
     End Object
     b_Designer=GUIButton'HUDFix.UT2K4Tab_W2K3OnslaughtMap.LinkDesignButton'
     ...
     Begin Object Class=moComboBox Name=MapComboBox
         ...
         TabOrder=2
     End Object
     co_MenuOptions=moComboBox'HUDFix.UT2K4Tab_W2K3OnslaughtMap.MapComboBox'
     ...
     Begin Object Class=GUIImage Name=BackgroundImage
         ...
         WinHeight=0.747156
         bAcceptsInput=True
         OnPreDraw=UT2K4Tab_W2K3OnslaughtMap.PreDrawMap
         OnDraw=UT2K4Tab_W2K3OnslaughtMap.DrawMap
         OnClick=UT2K4Tab_W2K3OnslaughtMap.SpawnClick
         OnRightClick=UT2K4Tab_W2K3OnslaughtMap.SelectClick
     End Object
     i_Background=GUIImage'HUDFix.UT2K4Tab_W2K3OnslaughtMap.BackgroundImage'
     ...
     End Object
     i_HintImage=GUIImage'HUDFix.UT2K4Tab_W2K3OnslaughtMap.IconHintImage'
     ...
     Begin Object Class=GUIImage Name=iTeam
         ...
         TabOrder=10
     End Object
     i_Team=GUIImage'HUDFix.UT2K4Tab_W2K3OnslaughtMap.iTeam'
     ...
     OnPreDraw=UT2K4Tab_W2K3OnslaughtMap.InternalOnPreDraw
     OnRendered=UT2K4Tab_W2K3OnslaughtMap.InternalOnPostDraw
}
