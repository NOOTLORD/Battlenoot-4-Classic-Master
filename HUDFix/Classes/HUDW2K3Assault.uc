...
class HUDW2K3Assault extends HudW2K3TeamDeathMatch
	config;
...
var int PushMinutes, PushSeconds;
...
var()	W2K3ObjectiveProgressDisplay	ObjectiveBoard;
...
simulated event PostBeginPlay()
{
	...
	ObjectiveBoard = Spawn(class'W2K3ObjectiveProgressDisplay', Owner);
...
simulated function UpdateTeamHud()
{
	...
	if ( ASGRI.RoundTimeLimit > 0 ) // freeze time when round is over
	{
		...
		else
		{
			...
			RoundTimeMinutes.OffsetX	= default.RoundTimeMinutes.OffsetX - 55; //020
			RoundTimeSeconds.OffsetX	= default.RoundTimeSeconds.OffsetX - 50; //110
		}
	}
...
defaultproperties
{
     ...
     RoundTimeMinutes=(RenderStyle=STY_Alpha,MinDigitCount=2,TextureScale=0.200000,DrawPivot=DP_MiddleLeft,OffsetX=130,OffsetY=75,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     RoundTimeSeconds=(RenderStyle=STY_Alpha,MinDigitCount=2,TextureScale=0.200000,DrawPivot=DP_MiddleLeft,OffsetX=360,OffsetY=75,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255),bPadWithZeroes=1)
     ReinforceSprNum=(RenderStyle=STY_Alpha,MinDigitCount=2,TextureScale=0.200000,DrawPivot=DP_MiddleLeft,OffsetX=175,OffsetY=70,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255),bPadWithZeroes=1)
     TeleportSprNum=(RenderStyle=STY_Alpha,MinDigitCount=2,TextureScale=0.200000,DrawPivot=DP_MiddleLeft,PosY=0.120000,OffsetX=175,OffsetY=70,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255),bPadWithZeroes=1)
