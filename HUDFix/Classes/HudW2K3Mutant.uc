...
class HudW2K3Mutant extends HudW2K3DeathMatch;
...
var()	globalconfig	bool	bCenterRadar;
var()	bool						bTestHud;
...
var()	float						BFIOffsetX, BFIOriginY, BFISizeX, BFISizeY, BFIMargin, BFIPulseRate;
...
defaultproperties
{
     TopRadarBG=(WidgetTexture=Texture'InterfaceContent.HUD.SkinA',RenderStyle=STY_Alpha,TextureCoords=(X1=142,Y1=880,Y2=1023),TextureScale=0.350000,DrawPivot=DP_UpperMiddle,PosX=0.500000,PosY=0.120000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
