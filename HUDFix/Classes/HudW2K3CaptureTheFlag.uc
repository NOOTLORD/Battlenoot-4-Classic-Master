class HudW2K3CaptureTheFlag extends HudW2k3TeamDeathMatch;
...
simulated function ShowTeamScorePassA(Canvas C)
{
	...
	if ( RedBase != None )
	{
		...
		if (bCorrectAspectRatio)
			Draw2DLocationDot(C, RedBase.Location,0.5 - 0.04*HUDScale*(ResScaleY/ResScaleX), 0.0365*HUDScale, 0.0305*HUDScale*(ResScaleY/ResScaleX), 0.0405*HUDScale);
		else	Draw2DLocationDot(C, RedBase.Location,0.5 - 0.04*HUDScale, 0.0365*HUDScale, 0.0305*HUDScale, 0.0405*HUDScale);
	}
	if ( BlueBase != None )
	{
		C.DrawColor = BlueColor;
		if (bCorrectAspectRatio)
			Draw2DLocationDot(C, BlueBase.Location,0.5 + 0.026*HUDScale*(ResScaleY/ResScaleX), 0.0365*HUDScale, 0.0305*HUDScale*(ResScaleY/ResScaleX), 0.0405*HUDScale);
		else	Draw2DLocationDot(C, BlueBase.Location,0.5 + 0.026*HUDScale, 0.0365*HUDScale, 0.0305*HUDScale, 0.0405*HUDScale);
	}
