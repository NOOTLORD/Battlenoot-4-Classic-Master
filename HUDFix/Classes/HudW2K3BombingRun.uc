class HudW2K3BombingRun extends HudW2K3TeamDeathMatch;
...
simulated function ShowTeamScorePassA(Canvas C)
{
	...
	if (bCorrectAspectRatio)
		Draw2DLocationDot(C, Pos, 0.5 - 0.0075*HUDScale*(ResScaleY/ResScaleX), 0.044*HUDScale, 0.034*HUDScale*(ResScaleY/ResScaleX), 0.046*HUDScale);
	else Draw2DLocationDot(C, Pos, 0.5 - 0.0075*HUDScale, 0.044*HUDScale, 0.034*HUDScale, 0.046*HUDScale);
}
