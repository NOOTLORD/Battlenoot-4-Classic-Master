class HudWCaptureTheFlag extends HudCCaptureTheFlag;
...
simulated function ShowTeamScorePassA(Canvas C)
{
	...
	if ( bShowPoints )
	{
		...
		if ( RedBase != None )
		{
			C.DrawColor = HudColorRed;
			if (bCorrectAspectRatio)
				Draw2DLocationDot(C, RedBase.Location,0.5 - REDtmpPosX*HUDScale*(ResScaleY/ResScaleX), REDtmpPosY*HUDScale, REDtmpScaleX*HUDScale*(ResScaleY/ResScaleX), REDtmpScaleY*HUDScale);
			else Draw2DLocationDot(C, RedBase.Location,0.5 - REDtmpPosX*HUDScale, REDtmpPosY*HUDScale, REDtmpScaleX*HUDScale, REDtmpScaleY*HUDScale);
		}
		if ( BlueBase != None )
		{
			C.DrawColor = HudColorBlue;
			if (bCorrectAspectRatio)
				Draw2DLocationDot(C, BlueBase.Location,0.5 + BLUEtmpPosX*HUDScale*(ResScaleY/ResScaleX), BLUEtmpPosY*HUDScale, BLUEtmpScaleX*HUDScale*(ResScaleY/ResScaleX), BLUEtmpScaleY*HUDScale);
			else Draw2DLocationDot(C, BlueBase.Location,0.5 + BLUEtmpPosX*HUDScale, BLUEtmpPosY*HUDScale, BLUEtmpScaleX*HUDScale, BLUEtmpScaleY*HUDScale);
		}
