class HudW2K3TeamDeathMatch extends HudW2K3DeathMatch;
...
simulated function DrawHudPassA (Canvas C)
{
	...
	{
		if (Links >0)
	        DrawNumericWidgetAsTiles (C, totalLinks, DigitsBig);
...
simulated function ShowTeamScorePassA(Canvas C)
{
	if ( bShowPoints )
	{
    	DrawWidgetAsTile (C, LTeamHud[2], true);
		DrawWidgetAsTile (C, LTeamHud[1], true);
		DrawWidgetAsTile (C, LTeamHud[0]);

		DrawWidgetAsTile (C, RTeamHud[2], true);
		DrawWidgetAsTile (C, RTeamHud[1], true);
		DrawWidgetAsTile (C, RTeamHud[0]);
	}
}
...
simulated function UpdateTeamHud()
{
    ...
    for (i = 0; i < 2; i++)
    {
		...
		LTeamHud[2].Scale = float(ScoreTeam[0].Value) / float(GRI.GoalScore);
		RTeamHud[2].Scale = float(ScoreTeam[1].Value) / float(GRI.GoalScore);
...
defaultproperties
{
     ...
     ScoreTeam(1)=(RenderStyle=STY_Alpha,MinDigitCount=2,TextureScale=0.240000,DrawPivot=DP_MiddleLeft,PosX=0.500000,PosY=0.010000,OffsetX=150,OffsetY=80,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     ...
     LTeamHud(0)=(WidgetTexture=Texture'InterfaceContent.HUD.SkinA',RenderStyle=STY_Alpha,TextureCoords=(X1=979,Y1=900,X2=611,Y2=1023),TextureScale=0.300000,DrawPivot=DP_UpperRight,PosX=0.500000,PosY=0.010000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     ...
     LTeamHud(2)=(WidgetTexture=Texture'InterfaceContent.HUD.SkinA',RenderStyle=STY_Alpha,TextureCoords=(X1=979,Y1=654,X2=611,Y2=776),TextureScale=0.300000,DrawPivot=DP_UpperRight,PosX=0.500000,PosY=0.010000,ScaleMode=SM_Left,Scale=1.000000,Tints[0]=(R=255,A=75),Tints[1]=(B=255,G=64,A=75))
     RTeamHud(0)=(WidgetTexture=Texture'InterfaceContent.HUD.SkinA',RenderStyle=STY_Alpha,TextureCoords=(X1=611,Y1=900,X2=979,Y2=1023),TextureScale=0.300000,PosX=0.500000,PosY=0.010000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=200),Tints[1]=(B=255,G=255,R=255,A=200))
     ...
     RTeamHud(2)=(WidgetTexture=Texture'InterfaceContent.HUD.SkinA',RenderStyle=STY_Alpha,TextureCoords=(X1=611,Y1=654,X2=979,Y2=776),TextureScale=0.300000,PosX=0.500000,PosY=0.010000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(R=255,A=75),Tints[1]=(B=255,G=64,A=75))
